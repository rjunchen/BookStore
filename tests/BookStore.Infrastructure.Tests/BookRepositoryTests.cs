...
namespace BookStore.Infrastructure.Tests
{
    public class BookRepositoryTests
    {
        ...
        {
            _options = BookStoreTestsHelper.BookStoreDbContextOptionsSQLiteInMemory();
            BookStoreTestsHelper.CreateDataBaseSQLiteInMemory(_options);
        }
        ...
        {
            await BookStoreTestsHelper.CleanDataBase(_options);
